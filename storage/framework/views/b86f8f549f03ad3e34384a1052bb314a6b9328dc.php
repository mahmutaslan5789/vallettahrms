                        ...
                        <div class="row d-flex justify-content-between">
                            ...
                            <?php if(\Auth::user()->type == 'company' && \Auth::user()->plan == $plan->id): ?>
                                <p class="mb-0">
                                    ...
                                    <?php echo e(!empty($plan_expire_date) ? \Auth::user()->dateFormat($plan_expire_date) : 'Life time'); ?>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/ZantrikTechnologies/Desktop/hrmsgo/resources/views/plan/index.blade.php ENDPATH**/ ?>