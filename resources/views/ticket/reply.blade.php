                            ...
                            <div class="card-body p-0">
                                ...
                                <div class="p-4 border-bottom">
                                    ...
                                    @elseif($ticket->priority == 'low')
                                        <div class="badge bg-warning mb-2">{{ __('Low') }}
                                        </div>
                                    @elseif($ticket->priority == 'high')
                                        <div class="badge bg-success mb-2">{{ __('High') }}
                                        </div>
                        ...
                        <div class="row">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <textarea class="form-control form-control-light mb-2" name="description" placeholder="Your comment"
